...
import no.uio.ifi.in2000.team20.team20app.data.repository.MapLayerRepositoryImpl
...
import no.uio.ifi.in2000.team20.team20app.data.repository.UrlFormatterRepository
import no.uio.ifi.in2000.team20.team20app.data.repository.UrlFormatterRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindMapLayerRepository(impl: MapLayerRepositoryImpl): MapLayerRepository

    @Binds
    @Singleton
    abstract fun bindUrlFormatterRepository(impl: UrlFormatterRepositoryImpl): UrlFormatterRepository
}
