...
fun SavedScreen(
    ...
    Column(
        modifier = modifier
            .fillMaxSize()
            .padding(
                top = if (compactScreenWidth) 48.dp else 32.dp,
                start = if (compactScreenWidth) DEFAULT_PADDING_DP.dp else LARGE_PADDING_DP.dp,
                end = if (compactScreenWidth) DEFAULT_PADDING_DP.dp else 80.dp,
                bottom = if(compactScreenWidth) 32.dp else LARGE_PADDING_DP.dp
            ),
